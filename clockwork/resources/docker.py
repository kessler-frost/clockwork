...
class DockerResource(Resource):
    ...
    image: str | None = Field(None, description="Docker image with tag - prefer official, well-maintained images", examples=["nginx:alpine", "postgres:15-alpine", "redis:7-alpine"])
